...
/**
 * A subclass class of the abstract User class.
 */
public class AdminUser extends User implements Buyer, Seller {
   ...
   */
  public AdminUser(final String username, final int credit) {
    super(username, credit, User.UserType.ADMIN);
